...
mod tests {
    ...
    fn output_chunk(stream: tai_proto::OutputStream, data: &str) -> DaemonMessage {
        DaemonMessage::OutputChunk {
            request_id: 1,
            stream,
    ...
    fn output_chunk_translates_to_agent_message_chunk() {
        let msg = output_chunk(tai_proto::OutputStream::Answer, "Hello, world!");
    ...
    fn output_chunk_reasoning_also_translates() {
        let msg = output_chunk(tai_proto::OutputStream::Reasoning, "thinking...");
